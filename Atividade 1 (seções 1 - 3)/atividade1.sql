...
/* 
9. Exiba os dados de todas as contas com saldo superior a R$ 9.000, 
ordenados do maior para o menor saldo. 
*/
SELECT * 
FROM conta
WHERE saldo > 9000
...
/* 
13. Exiba os nomes dos clientes que não são das cidades de 
Teresópolis nem Campos dos Goytacazes. 
*/
SELECT cliente_nome, cidade
FROM cliente
